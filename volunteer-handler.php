...
$conf = "Thank you for your interest in volunteering with the West Point Parents Club of Alabama!\n\n"
...
try {
    ...
    $conf_mail->Subject = 'Volunteer Interest Received — West Point Parents Club of Alabama';
    $conf_mail->Body    = $conf;
    $conf_mail->send();
} catch (PHPMailerException $e) {
